...
(function() {
  ...
  $("[data-toggle]").on(clickOrTouch, function() {
    ...
    var $strategyId = $("[data-modal-id]").html(
      'You have chosen <span class="orange bold text-center">' +
        $("#strategy-" + $nrId + "").html() +
        "</span>"
    );
...
(function() {
  var clickOrTouch = "click touchstart";
  $(
    ".newsfeed-box > .newsfeed-box-content > p > a, .newsfeed-box > .newsfeed-box-reviews > p > a"
...
(function() {
  ...
  $("#sign-me-up").on(clickOrTouch, function(e) {
    ...
    $this.html(
      'Welcome on board <span class="white text-center"><i class="fly-away fa fa-send"></i></span>'
    );
  });
